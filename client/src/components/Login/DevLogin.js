...
const devCredentials = [
  ...
  { id: "Minkua", password: "password3", name: "Riyansh" }
];
...
const DevLogin = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (id.trim() === '' && password.trim() === '') {
      ...
      // Simulate API call
      setTimeout(() => {
        const devUser = devCredentials.find(
  ...
  return (
    <div className="relative flex justify-center items-center h-screen bg-gray-900 overflow-hidden">
      ...
      >
        <h2 className="text-3xl font-bold mb-6 text-center text-white">Creator Login</h2>
        <AnimatePresence>
          {error && (
            <motion.p
